  ...
  return (
    <section className="py-20 px-6 relative bg-gray-900/50">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className="absolute top-20 left-10 w-72 h-72 bg-purple-500/5 rounded-full blur-3xl animate-pulse"
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <p className="text-gray-300 text-lg">
          From bagging a degree in mechanical engineering, to completing a
          comprehensive 1-year software engineering apprenticeship at Holberton
          School in 2021, then progressing to a 6-month DevOps engineering
          internship in 2022 and ultimately securing a full-time position as a
          frontend engineer at Blockops network, I have acquired pertinent
          expertise and experience encompassing the entire scope of a software's
          life cycle.
        </p>
          ...
          <div className="space-y-6">
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 hover:bg-white/10 hover:border-purple-400/30 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2 group">
              ...
              <p className="text-gray-300 leading-relaxed group-hover:text-gray-200 transition-colors duration-300">
                ...
                <span className="text-cyan-500 font-semibold">responsive</span>,{" "}
                <span className="text-cyan-500 font-semibold">interactive</span>
                , and{" "}
                <span className="text-cyan-500 font-semibold">performant</span>{" "}
                user interfaces using React & TypeScript
              </p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 hover:bg-white/10 hover:border-cyan-400/30 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2 group">
              ...
              <p className="text-gray-300 leading-relaxed group-hover:text-gray-200 transition-colors duration-300">
                I bridge the gap between design and development, creating
                pixel-perfect implementations with smooth animations and
                intuitive user experiences that engage and delight users.
              </p>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-br from-purple-600/10 to-blue-600/10 backdrop-blur-lg rounded-2xl p-8 border border-white/10 hover:border-purple-400/30 transition-all duration-300 transform hover:scale-105">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  {
                    name: "Tailwind CSS",
                    color: "hover:bg-cyan-500/20 hover:text-cyan-300",
                  },
                  {
                    name: "Three.js",
